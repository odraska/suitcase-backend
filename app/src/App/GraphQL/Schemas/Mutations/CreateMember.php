...
use SLONline\App\GraphQL\Resolvers\CreateMemberResolver;

/**
 * Create Member Mutation GraphQL Schema Updater
 *
 * @author    Lubos Odraska <odraska@slonline.sk>
 * @copyright Copyright (c) 2025, SLONline, s.r.o.
 */
class CreateMember implements PartialSchemaUpdater
{
    /**
     * @inheritDoc
     */
