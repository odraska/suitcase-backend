...
/**
 * Heading Content Block Type GraphQL Schema Updater
 *
 * @author    Lubos Odraska <odraska@slonline.sk>
 * @copyright Copyright (c) 2026, SLONline, s.r.o.
 */
class Heading implements PartialSchemaUpdater
{
    /**
    ...
    {
        $schema->addType(Type::create('HeadingContentBlock')
            //->addInterface('ContentBlockInterface')
            ->addField('level', 'Int!')
